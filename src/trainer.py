...
class PROTACTrainer:
    ...
    def plot_expert_correlations(self, views_test, y_test, output_path):
        ...
        axes[0].set_title(f"Correlation for Inactive Compounds (n={len(df_inactives)})", 
        ...
        axes[1].set_title(f"Correlation for Active Compounds (n={len(df_actives)})", 
                          fontsize=20, fontweight='bold', pad=15)
        ...
        plt.suptitle("Correlation of Expert Predictions: Class-Specific Analysis", 
